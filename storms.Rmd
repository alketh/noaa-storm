...
events `blizzard`, `cold`, `fire`, `flood`, `hail`, `heat`, `hurricane`, `lightning`, `microburst`, `rain`, `snow`, 
`thunderstorm`, `tornado`, `tsunami`, `typhoon`, `wind` and `waterspout`
...
small number of deaths which happen on a regular basis e.g. `heat` are weighted similar to severe events which only happen in rare cases. 
